...
public class FacilityDetailPanel extends JPanel {
	...
	private void setupLayout() {
		// 상단 바 (우측 정렬된 닫기 버튼 포함)
				...
				topBar.setOpaque(false); // 투명하게 해서 둥근 배경 유지
				topBar.add(closeButton);

				// 레이아웃 배치
				add(topBar, BorderLayout.NORTH); // 북쪽에 닫기 버튼
